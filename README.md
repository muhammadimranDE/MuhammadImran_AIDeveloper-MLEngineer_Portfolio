...
+92 321 8866546 | imrandogarpsf86@gmail.com | LinkedIn | Portfolio  
...
School Education Department, Punjab, Pakistan | Sep 2014 – Dec 2023Lahore, Pakistan  
...
Basic Input/Output in C++: Calculated sums and averages.  
Sorting Algorithms Visualization: Implemented bubble and selection sort.  
Simple Calculator in Python: Built arithmetic tool.  
Student Grade Management: Analyzed grades with arrays and loops.  
File Handling for Attendance: Logged data in text files.


College-Level Practicals:  
Matrix Operations in MATLAB: Computed determinants with visualization.  
Database Querying with SQL: Managed student records.  
Search Algorithm Efficiency: Compared linear and binary search.  
Data Visualization with Python: Plotted trends with Matplotlib.  
Geometric Shape Simulation: Calculated areas with Python Turtle.
...
M.Sc. Mathematical Data Science | In Progress – Expected Nov 2025Göttingen, Germany  
...
B.Sc. (Hons) Mathematics & Bachelor of Education | Sep 2008 – Nov 2012Lahore, Pakistan  
...
LinkedIn: linkedin.com/in/muhammad-imran  
Twitter: twitter.com/lmranDogar.psf  
Email: imrandogarpsf86@gmail.com  
WhatsApp: +92 321 8866546  
Resume: Download PDF
